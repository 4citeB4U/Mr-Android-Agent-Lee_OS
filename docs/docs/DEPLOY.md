...
### Steps
1. Open `android/` in Android Studio (create with [PWABuilder](https://www.pwabuilder.com/) or [Bubblewrap](https://github.com/leewayChromeLabs/bubblewrap))
2. Set your Cloudflare Pages URL as the TWA origin
3. Build a signed APK/AAB
4. Deploy to leeway Play or side-load
...
|---|---|---|
| `leeway_API_KEY` | _(empty)_ | leeway API key (online mode) |
| `OFFLINE_MODE` | `0` | Set `1` to disable leeway |
