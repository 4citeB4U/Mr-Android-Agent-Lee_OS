...
# Expected: {"status":"ok","offline_mode":false,"leeway_available":true,...}
```
...
### leeway quota exceeded

- Check your leeway API quota via the [LeeWay Innovations leeway portal](https://leewayinnovations.com) or leeway Cloud Console
- Increase `ROUTER_leeway_THRESHOLD` to route fewer requests to leeway
